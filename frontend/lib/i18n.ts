...
const translations: Record<AppLocale, Record<string, string>> = {
  ko: {
    ...
    "home.howEyebrow": "이용 방법",
    "home.howTitle": "세 단계로 자연스럽게 연결됩니다.",
    "home.flowTitle": "한눈에 보는 이용 흐름",
    "home.flowBody": "프로필을 작성하면, AI가 조건에 맞는 상대를 연결하고 번역 채팅으로 자연스럽게 대화를 이어갈 수 있습니다.",
    "home.flowTrustLabel": "신뢰 포인트",
    "home.step1Label": "01",
    "home.step1Title": "프로필 작성",
    "home.step1Body": "국가, 성별, 관심사와 언어 정보를 입력합니다.",
    "home.step2Label": "02",
    "home.step2Title": "AI 매칭",
    "home.step2Body": "조건에 맞는 상대가 있으면 자동으로 연결됩니다.",
    "home.step3Label": "03",
    "home.step3Title": "번역 채팅",
    ...
    "home.serviceNote": "안전한 서비스 운영과 문의 지원은 운영팀이 지속적으로 확인합니다.",
  ...
  ja: {
    ...
    "home.howEyebrow": "使い方",
    "home.howTitle": "3つのステップで自然につながります。",
    "home.flowTitle": "利用の流れがひと目でわかります",
    "home.flowBody": "プロフィールを作成すると、AIが条件に合う相手をつなぎ、翻訳チャットで自然な会話をサポートします。",
    "home.flowTrustLabel": "信頼ポイント",
    "home.step1Label": "01",
    "home.step1Title": "プロフィール作成",
    "home.step1Body": "国、性別、関心事、言語情報を入力します。",
    "home.step2Label": "02",
    "home.step2Title": "AIマッチング",
    "home.step2Body": "条件に合う相手がいれば自動でつながります。",
    "home.step3Label": "03",
    "home.step3Title": "翻訳チャット",
    "home.step3Body": "原文と翻訳文を見ながら会話を続けられます。",
    "home.visualBadge": "AIおすすめ日韓マッチング",
    "home.point1Title": "本人確認",
    "home.point1Body": "確認されたプロフィール情報をもとに、信頼できる出会いをサポートします。",
    "home.point2Title": "翻訳サポート",
    ...
    "home.serviceNote": "安全なサービス運営とお問い合わせ対応は、運営チームが継続的に確認します。",
