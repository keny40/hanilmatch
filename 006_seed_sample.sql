...
INSERT INTO messages (id, sender_id, receiver_id, original_text, translated_text, language_from, language_to, created_at) VALUES
    ('77777777-7777-7777-7777-777777777777', '11111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', '안녕하세요. 사진 정말 멋지네요.', 'こんにちは。写真がとても素敵ですね。', 'ko', 'ja', NOW()),
    ('88888888-8888-8888-8888-888888888888', '33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'ありがとうございます。ソウルにはよく行きますか。', '감사합니다. 서울에는 자주 가시나요?', 'ja', 'ko', NOW());
